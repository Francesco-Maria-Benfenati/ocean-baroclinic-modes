...
- File [run_plots.py](https://github.com/Francesco-Maria-Benfenati/ocean-baroclinic-modes-1.0/blob/main/main.py) is for plotting output results in NetCDF output file. Output products are saved in a directiory within the same one as the input dataset.
